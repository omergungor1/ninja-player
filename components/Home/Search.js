    ...
    return (
        <div className="max-w-md mx-auto mt-4">
            ...
            <div className="relative">
                ...
                <input onChange={(text) => { setSearchText(text.target.value) }} value={searchText} type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search with ZipCode" />
